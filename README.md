This is a project in progress to help me understand how to create automatic data ingestion pipelines. It is hosted on my personal linux server. 
...
On arrival, the S3 Bucket triggers an AWS Lambda function to observe the daily ingestion metadata and send success/failures health reports to my email via AWS SNS. The full pipeline is triggered automatically every night via cron and shell scripts. 
